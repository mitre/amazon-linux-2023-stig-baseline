control 'SV-274091' do
  title 'Amazon Linux 2023 must audit all uses of the init_module and finit_module system calls.'
...
The system call rules are loaded into a matching engine that intercepts each system call made by all programs on the system. Therefore, it is very important to use system call rules only when absolutely necessary since these affect performance. The more rules, the bigger the performance hit. The performance can be helped, however, by combining system calls into one rule whenever possible.'
  desc 'check', 'Verify Amazon Linux 2023 is configured to audit the execution of the "init_module" and "finit_module" system calls with the following command:
...
If audit rule is not defined for the "delete_module" system call, or the line returned is commented out, this is a finding.'
  desc 'fix', 'Configure Amazon Linux 2023 to generate an audit event for any successful/unsuccessful use of the "init_module" and "finit_module" system calls by adding or updating the following rule in the "/etc/audit/rules.d/audit.rules" file:
...
$ sudo augenrules --load'
  ...
  tag satisfies: ['SRG-OS-000062-GPOS-00031', 'SRG-OS-000037-GPOS-00015', 'SRG-OS-000042-GPOS-00020', 'SRG-OS-000392-GPOS-00172', 'SRG-OS-000462-GPOS-00206', 'SRG-OS-000471-GPOS-00215', 'SRG-OS-000471-GPOS-00216', 'SRG-OS-000477-GPOS-00222', 'SRG-OS-000064-GPOS-00033', 'SRG-OS-000466-GPOS-00210', 'SRG-OS-000458-GPOS-00203']
  tag gid: 'V-274091'
  tag rid: 'SV-274091r1120261_rule'
  tag stig_id: 'AZLX-23-002135'
  tag fix_id: 'F-78087r1120260_fix'
