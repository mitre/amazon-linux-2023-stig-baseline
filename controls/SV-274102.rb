...
Audit tools include, but are not limited to, vendor-provided and open source audit tools needed to successfully view and manipulate audit information system activity and records. Audit tools include custom queries and report generators.'
  desc 'check', 'Verify Amazon Linux 2023 audit tools are owned by "root" with the following command:
...
If any audit tools do not have an owner of "root", this is a finding.'
  desc 'fix', 'Configure Amazon Linux 2023 audit tools to be owned by "root" by running the following command:
...
Replace "[audit_tool]" with each audit tool not owned by "root".'
  ...
  tag gid: 'V-274102'
  tag rid: 'SV-274102r1120294_rule'
  tag stig_id: 'AZLX-23-002195'
  tag fix_id: 'F-78098r1120293_fix'
  tag cci: ['CCI-001493']
