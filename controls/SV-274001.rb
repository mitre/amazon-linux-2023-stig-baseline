...
Restricting access to the kernel message buffer limits access to only root. This prevents attackers from gaining additional system information as a nonprivileged user.'
  desc 'check', 'Verify Amazon Linux 2023 is configured to restrict access to the kernel message buffer with the following commands:
...
If "kernel.dmesg_restrict" is not set to "1" or is missing, this is a finding.'
  desc 'fix', 'Configure Amazon Linux 2023 to restrict access to the kernel message buffer.
...
$ sudo sysctl --system'
  ...
  tag gid: 'V-274001'
  tag rid: 'SV-274001r1198253_rule'
  tag stig_id: 'AZLX-23-000200'
  tag fix_id: 'F-77997r1119990_fix'
