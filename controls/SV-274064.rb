control 'SV-274064' do
  title 'Amazon Linux 2023, for PKI-based authentication, must enforce authorized access to the corresponding private key.'
...
Both the holders of a digital certificate and the issuing authority must protect the computers, storage devices, or whatever they use to keep the private keys.'
  desc 'check', 'Verify Amazon Linux 2023 SSH private key files have a passcode.
...
If the contents of the key are displayed, this is a finding.'
  desc 'fix', 'Configure Amazon Linux 2023 SSH private key files to have a passcode.
...
$ sudo ssh-keygen -n [passphrase]'
  ...
  tag gid: 'V-274064'
  tag rid: 'SV-274064r1120180_rule'
  tag stig_id: 'AZLX-23-001315'
  tag fix_id: 'F-78060r1120179_fix'
  tag cci: ['CCI-000186']
