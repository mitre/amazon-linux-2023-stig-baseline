control 'SV-283452' do
  title 'Amazon Linux 2023 must implement a FIPS 140-2/140-3 compliant systemwide cryptographic policy.'
  ...
  desc 'check', %q(Verify Amazon Linux 2023 is set to use a FIPS 140-2/140-3 compliant systemwide cryptographic policy.
...
If these commands do not return any output, this is a finding.)
  desc 'fix', 'Configure Amazon Linux 2023 to use a FIPS 140-2/140-3 compliant systemwide cryptographic policy.
...
$ sudo reboot'
  impact 0.7
  tag check_id: 'C-88017r1188498_chk'
  tag severity: 'high'
  tag gid: 'V-283452'
  tag rid: 'SV-283452r1188500_rule'
  tag stig_id: 'AZLX-23-001270'
  tag gtitle: 'SRG-OS-000396-GPOS-00176'
  tag fix_id: 'F-87922r1188499_fix'
  tag satisfies: ['SRG-OS-000396-GPOS-00176', 'SRG-OS-000393-GPOS-00173', 'SRG-OS-000394-GPOS-00174', 'SRG-OS-000120-GPOS-00061', 'SRG-OS-000424-GPOS-00188']
  tag 'documentable'
  tag cci: ['CCI-002450', 'CCI-002890', 'CCI-003123', 'CCI-000803', 'CCI-002421']
  tag nist: ['SC-13 b', 'MA-4 (6)', 'IA-7', 'SC-8 (1)']
  tag 'host'
