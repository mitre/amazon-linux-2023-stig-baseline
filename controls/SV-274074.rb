control 'SV-274074' do
  title 'Amazon Linux 2023 must take action when allocated audit record storage volume reaches 95 percent of the repository maximum audit record storage capacity.'
  ...
  desc 'check', 'Verify Amazon Linux 2023 is configured to take action in the event of allocated audit record storage volume reaches 95 percent of the repository maximum audit record storage capacity with the following command:
...
If there is no evidence that real-time alerts are configured on the system, this is a finding.'
  desc 'fix', 'Configure Amazon Linux 2023 so that the auditd service takes action in the event of allocated audit record storage volume reaching 95 percent of the repository maximum audit record storage capacity.
...
The audit daemon must be restarted for changes to take effect.'
  impact 0.5
  tag check_id: 'C-78165r1120208_chk'
  tag severity: 'medium'
  tag gid: 'V-274074'
  tag rid: 'SV-274074r1120210_rule'
  tag stig_id: 'AZLX-23-002050'
  tag gtitle: 'SRG-OS-000343-GPOS-00134'
  tag fix_id: 'F-78070r1120209_fix'
  tag 'documentable'
  tag cci: ['CCI-001855']
  tag nist: ['AU-5 (1)']
  tag 'host'
