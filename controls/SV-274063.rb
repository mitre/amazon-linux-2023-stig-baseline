control 'SV-274063' do
  title 'Amazon Linux 2023, for PKI-based authentication, must validate certificates by constructing a certification path (which includes status information) to an accepted trust anchor.'
...
If the root ca file is not a DOD-issued certificate with a valid date and installed in the /etc/sssd/pki/sssd_auth_ca_db.pem location, this is a finding.'
  desc 'fix', 'Configure Amazon Linux 2023 to have valid certificates by using AWS Certificate Manager (ACM) or another certificate manager to manage SSL/TLS certificates.
...
ACM will handle the certificate lifecycle management, including validation and trust chain establishment.'
  ...
  tag satisfies: ['SRG-OS-000066-GPOS-00034', 'SRG-OS-000384-GPOS-00167', 'SRG-OS-000775-GPOS-00230', 'SRG-OS-000403-GPOS-00182']
  tag gid: 'V-274063'
  tag rid: 'SV-274063r1120712_rule'
  tag stig_id: 'AZLX-23-001310'
  tag fix_id: 'F-78059r1120711_fix'
  tag cci: ['CCI-000185', 'CCI-001991', 'CCI-004068', 'CCI-004909', 'CCI-002470']
  tag nist: ['IA-5 (2) (a)', 'IA-5 (2) (b) (1)', 'IA-5 (2) (d)', 'IA-5 (2) (b) (2)', 'SC-17 b', 'SC-23 (5)']
  tag 'host'
  tag 'container'
