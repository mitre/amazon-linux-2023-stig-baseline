...
If the /dev/shm file system is not mounted with the "nosuid" option, this is a finding.'
  desc 'fix', 'Configure Amazon Linux 2023 so that "/dev/shm" is mounted with the "nosuid" option.
...
Modify "/etc/fstab" to use the "nosuid" option on the "/dev/shm" file system.'
  ...
  tag gid: 'V-274180'
  tag rid: 'SV-274180r1198347_rule'
  tag stig_id: 'AZLX-23-002590'
  tag fix_id: 'F-78176r1120527_fix'
  tag cci: ['CCI-001764']
  tag nist: ['CM-7 (2)']
  tag 'host'
