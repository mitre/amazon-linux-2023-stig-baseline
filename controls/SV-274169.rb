control 'SV-274169' do
  title 'Amazon Linux 2023 must enable discretionary access control on hardlinks.'
  ...
  desc 'check', 'Verify Amazon Linux 2023 is configured to enable DAC on hardlinks.
...
If "fs.protected_hardlinks" is not set to "1" or is missing, this is a finding.'
  desc 'fix', 'Configure Amazon Linux 2023 to enable DAC on hardlinks with the following:
...
$ sudo sysctl --system'
  ...
  tag gid: 'V-274169'
  tag rid: 'SV-274169r1120495_rule'
  tag stig_id: 'AZLX-23-002535'
  tag fix_id: 'F-78165r1120494_fix'
