control 'SV-274026' do
  title 'Amazon Linux 2023 must use cryptographic mechanisms to protect the integrity of audit tools.'
...
To address this risk, audit tools must be cryptographically signed to provide the capability to identify when the audit tools have been modified, manipulated, or replaced. An example is a checksum hash of the file or files.'
  desc 'check', 'Verify Amazon Linux 2023 is properly configured to protect the integrity of the Advanced Intrusion Detection Environment (AIDE) audit tools with the following command:
...
If there is no evidence of integrity protection, this is a finding.'
  desc 'fix', 'Configure Amazon Linux 2023 to protect the integrity of the AIDE audit tools.
...
/usr/sbin/augenrules p+i+n+u+g+s+b+acl+xattrs+sha512'
  ...
  tag gid: 'V-274026'
  tag rid: 'SV-274026r1120066_rule'
  tag stig_id: 'AZLX-23-001070'
  tag fix_id: 'F-78022r1120065_fix'
