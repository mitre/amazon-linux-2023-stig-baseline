control 'SV-274059' do
  title 'Amazon Linux 2023 must enable certificate-based smart card authentication.'
...
If "pam_cert_auth" is not set to "True", the line is commented out, or the line is missing, this is a finding.'
  desc 'fix', 'Configure Amazon Linux 2023 to have smart cards enabled in SSSD.
...
pam_cert_auth = True'
  ...
  tag satisfies: ['SRG-OS-000105-GPOS-00052', 'SRG-OS-000106-GPOS-00053', 'SRG-OS-000107-GPOS-00054', 'SRG-OS-000108-GPOS-00055', 'SRG-OS-000375-GPOS-00160', 'SRG-OS-000705-GPOS-00150']
  tag gid: 'V-274059'
  tag rid: 'SV-274059r1120165_rule'
  tag stig_id: 'AZLX-23-001290'
  tag fix_id: 'F-78055r1120164_fix'
