control 'SV-274110' do
  title 'Amazon Linux 2023 audit logs file must have mode "0600" or less permissive to prevent unauthorized access to the audit log.'
  desc 'Unauthorized disclosure of audit records can reveal system and configuration data to attackers, thus compromising its confidentiality.

Audit information includes all information (e.g., audit records, audit settings, audit reports) needed to successfully audit operating system activity.'
  desc 'check', %q(Verify Amazon Linux 2023 audit logs have a mode of "0600". 
...
If the audit logs have a mode more permissive than "0600", this is a finding.)
  desc 'fix', 'Configure Amazon Linux 2023 so that the audit logs have a mode of "0600".
...
$ sudo chmod 0400 $log_file.*'
  ...
  tag gid: 'V-274110'
  tag rid: 'SV-274110r1120318_rule'
  tag stig_id: 'AZLX-23-002235'
  tag fix_id: 'F-78106r1120317_fix'
