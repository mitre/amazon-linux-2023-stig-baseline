control 'SV-274061' do
  title 'Amazon Linux 2023 must implement certificate status checking for multifactor authentication.'
...
If there is no evidence of certificate status checking being used, this is a finding.'
  desc 'fix', 'Configure Amazon Linux 2023 to implement certificate status checking for multifactor authentication.
...
$ sudo systemctl restart sssd.service'
  impact 0.5
  tag check_id: 'C-78152r1120169_chk'
  tag severity: 'medium'
  tag gid: 'V-274061'
  tag rid: 'SV-274061r1120171_rule'
  tag stig_id: 'AZLX-23-001300'
  tag gtitle: 'SRG-OS-000375-GPOS-00160'
  tag fix_id: 'F-78057r1120170_fix'
