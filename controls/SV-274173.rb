...
access when the system is rebooted.'
  desc 'check', 'Verify Amazon Linux 2023 is configured to mask the debug-shell systemd service with the following command:
...
If the "debug-shell.service" is loaded and not masked, this is a finding.'
  desc 'fix', 'Configure Amazon Linux 2023 to mask the debug-shell systemd service with the following command:
...
$ sudo systemctl mask --now debug-shell.service'
  ...
  tag gid: 'V-274173'
  tag rid: 'SV-274173r1120507_rule'
  tag stig_id: 'AZLX-23-002555'
  tag fix_id: 'F-78169r1120506_fix'
