control 'SV-274060' do
  title 'Amazon Linux 2023 must map the authenticated identity to the user or group account for PKI-based authentication.'
...
If the certmap section does not exist, ask the SA to indicate how certificates are mapped to accounts. If there is no evidence of certificate mapping, this is a finding.'
  desc 'fix', 'Configure Amazon Linux 2023 to map the authenticated identity to the user or group account by adding or modifying the certmap section of the "/etc/sssd/sssd.conf file based on the following example:
...
$ sudo systemctl restart sssd.service'
  ...
  tag gid: 'V-274060'
  tag rid: 'SV-274060r1120168_rule'
  tag stig_id: 'AZLX-23-001295'
  tag fix_id: 'F-78056r1120167_fix'
  tag cci: ['CCI-000187']
