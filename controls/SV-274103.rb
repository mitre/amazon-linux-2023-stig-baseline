...
Audit tools include, but are not limited to, vendor-provided and open source audit tools needed to successfully view and manipulate audit information system activity and records. Audit tools include custom queries and report generators.'
  desc 'check', 'Verify Amazon Linux 2023 audit tools are group owned by "root" with the following command:
...
If any audit tools do not have a group owner of "root", this is a finding.'
  desc 'fix', 'Configure Amazon Linux 2023 audit tools to be group-owned by "root" by running the following command:
...
Replace "[audit_tool]" with each audit tool not group-owned by "root".'
  ...
  tag gid: 'V-274103'
  tag rid: 'SV-274103r1120297_rule'
  tag stig_id: 'AZLX-23-002200'
  tag fix_id: 'F-78099r1120296_fix'
  tag cci: ['CCI-001493']
