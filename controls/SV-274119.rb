control 'SV-274119' do
  title 'Amazon Linux 2023 library directories must be group-owned by root or a system account.'
...
This requirement applies to operating systems with software libraries that are accessible and configurable, as in the case of interpreted languages. Software libraries also include privileged programs which execute with escalated privileges. Only qualified and authorized individuals shall be allowed to obtain access to information system components for purposes of initiating changes, including upgrades and modifications.'
  desc 'check', %q(Verify Amazon Linux 2023 systemwide shared library directories are group-owned by "root" with the following command:
...
$ sudo chgrp root [DIRECTORY]'
  impact 0.5
  tag check_id: 'C-78210r1120343_chk'
  tag severity: 'medium'
  tag gid: 'V-274119'
  tag rid: 'SV-274119r1120345_rule'
  tag stig_id: 'AZLX-23-002280'
  tag gtitle: 'SRG-OS-000259-GPOS-00100'
  tag fix_id: 'F-78115r1120344_fix'
  tag 'documentable'
  tag cci: ['CCI-001499']
  tag nist: ['CM-5 (6)']
  tag 'host'
