...
Setting the kernel.perf_event_paranoid kernel parameter to "2" prevents attackers from gaining additional system information as a nonprivileged user.'
  desc 'check', 'Verify Amazon Linux 2023 is configured to prevent kernel profiling by nonprivileged users with the following commands:
...
If "kernel.perf_event_paranoid" is not set to "2" or is missing, this is a finding.'
  desc 'fix', 'Configure Amazon Linux 2023 to prevent kernel profiling by nonprivileged users.
...
$ sudo sysctl --system'
  ...
  tag gid: 'V-274002'
  tag rid: 'SV-274002r1198253_rule'
  tag stig_id: 'AZLX-23-000205'
  tag fix_id: 'F-77998r1119993_fix'
