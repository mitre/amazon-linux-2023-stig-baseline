...
Examples of nonessential capabilities include, but are not limited to, games, software packages, tools, and demonstration software, not related to requirements or providing a wide array of functionality not required for every mission, but which cannot be disabled.'
  desc 'check', 'Verify Amazon Linux 2023 does not have the sendmail package installed with the following command:

$ dnf list --installed sendmail
Error: No matching Packages to list

If the "sendmail" package is installed, this is a finding.'
  desc 'fix', 'Configure Amazon Linux 2023 to not have the sendmail package installed with the following command:

$ sudo dnf -y remove sendmail'
  impact 0.5
  tag check_id: 'C-78099r1120010_chk'
  tag severity: 'medium'
  tag gid: 'V-274008'
  tag rid: 'SV-274008r1120012_rule'
  tag stig_id: 'AZLX-23-000305'
  tag gtitle: 'SRG-OS-000095-GPOS-00049'
  tag fix_id: 'F-78004r1120011_fix'
  tag 'documentable'
  tag cci: ['CCI-000381']
  tag nist: ['CM-7 a']
  tag 'host'
