...
from insider threats and the advanced persistent threat.'
  desc 'check', 'Verify Amazon Linux 2023 is configured to audit the execution of the "execve" system call with the following command:
...
$ sudo augenrules --load'
  ...
  tag gid: 'V-274086'
  tag rid: 'SV-274086r1120246_rule'
  tag stig_id: 'AZLX-23-002110'
  tag fix_id: 'F-78082r1120245_fix'
